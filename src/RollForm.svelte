...
<div id='wrapper'>
  <div id='inputWrapper'>
    <label id='rollInputLabelWrapper'>
      ...
      <div id="rollWrap">
        <input id="rollCountInput" placeholder="Rolls?" class="inputField" type=number bind:value={rollInputValue} min=1 max=10>
        <input id="rollCountSlider" class="inputSlider" type=range bind:value={rollInputValue} min=1 max=10>
      </div>
    </label>
